...
func mq_NTT(a *uint16, logn uint) {
	var (
		n uint64
		t uint64
		m uint64
	...
	for m = 1; m < n; m <<= 1 {
		...
		for func() uint64 {
			...
			for j = j1; j < j2; j++ {
				...
				u = uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(j))))
				v = mq_montymul(uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(j+ht)))), s)
				*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(j))) = uint16(mq_add(u, v))
				*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(j+ht))) = uint16(mq_sub(u, v))
			}
		}
		t = ht
	}
}
func mq_iNTT(a *uint16, logn uint) {
	var (
		n  uint64
		t  uint64
		m  uint64
	...
	for m > 1 {
		...
		for func() uint64 {
			...
			for j = j1; j < j2; j++ {
				...
				u = uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(j))))
				v = uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(j+t))))
				*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(j))) = uint16(mq_add(u, v))
				w = mq_sub(u, v)
				*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(j+t))) = uint16(mq_montymul(w, s))
			}
		}
		t = dt
		m = hm
	...
	for m = 0; m < n; m++ {
		*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(m))) = uint16(mq_montymul(uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(a), unsafe.Sizeof(uint16(0))*uintptr(m)))), ni))
	}
}
func mq_poly_tomonty(f *uint16, logn uint) {
	var (
		u uint64
		n uint64
	)
	n = uint64(1 << logn)
	for u = 0; u < n; u++ {
		*(*uint16)(unsafe.Add(unsafe.Pointer(f), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(mq_montymul(uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(f), unsafe.Sizeof(uint16(0))*uintptr(u)))), R2))
	}
}
func mq_poly_montymul_ntt(f *uint16, g *uint16, logn uint) {
	var (
		u uint64
		n uint64
	)
	n = uint64(1 << logn)
	for u = 0; u < n; u++ {
		*(*uint16)(unsafe.Add(unsafe.Pointer(f), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(mq_montymul(uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(f), unsafe.Sizeof(uint16(0))*uintptr(u)))), uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(g), unsafe.Sizeof(uint16(0))*uintptr(u))))))
	}
}
func mq_poly_sub(f *uint16, g *uint16, logn uint) {
	var (
		u uint64
		n uint64
	)
	n = uint64(1 << logn)
	for u = 0; u < n; u++ {
		*(*uint16)(unsafe.Add(unsafe.Pointer(f), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(mq_sub(uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(f), unsafe.Sizeof(uint16(0))*uintptr(u)))), uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(g), unsafe.Sizeof(uint16(0))*uintptr(u))))))
	}
}
func PQCLEAN_FALCON512_CLEAN_to_ntt_monty(h *uint16, logn uint) {
	mq_NTT(h, logn)
	mq_poly_tomonty(h, logn)
}
func PQCLEAN_FALCON512_CLEAN_verify_raw(c0 *uint16, s2 *int16, h *uint16, logn uint, tmp *uint8) int {
	var (
		u  uint64
		n  uint64
		tt *uint16
	...
	n = uint64(1 << logn)
	tt = (*uint16)(unsafe.Pointer(tmp))
	for u = 0; u < n; u++ {
		var w uint32
		w = uint32(*(*int16)(unsafe.Add(unsafe.Pointer(s2), unsafe.Sizeof(int16(0))*uintptr(u))))
		w += uint32(int32(Q & int(uint32(int32(-(int(w) >> 31))))))
		*(*uint16)(unsafe.Add(unsafe.Pointer(tt), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(w)
	}
	mq_NTT(tt, logn)
	...
	for u = 0; u < n; u++ {
		var w int32
		w = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(tt), unsafe.Sizeof(uint16(0))*uintptr(u))))
		w -= int32(Q & (-(((int(Q >> 1)) - int(uint32(w))) >> 31)))
		*(*int16)(unsafe.Add(unsafe.Pointer((*int16)(unsafe.Pointer(tt))), unsafe.Sizeof(int16(0))*uintptr(u))) = int16(w)
	}
	return PQCLEAN_FALCON512_CLEAN_is_short((*int16)(unsafe.Pointer(tt)), s2, logn)
}
func PQCLEAN_FALCON512_CLEAN_compute_public(h *uint16, f *int8, g *int8, logn uint, tmp *uint8) int {
	var (
		u  uint64
		n  uint64
		tt *uint16
	...
	tt = (*uint16)(unsafe.Pointer(tmp))
	for u = 0; u < n; u++ {
		*(*uint16)(unsafe.Add(unsafe.Pointer(tt), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(mq_conv_small(int(*(*int8)(unsafe.Add(unsafe.Pointer(f), u)))))
		*(*uint16)(unsafe.Add(unsafe.Pointer(h), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(mq_conv_small(int(*(*int8)(unsafe.Add(unsafe.Pointer(g), u)))))
	}
	mq_NTT(h, logn)
	mq_NTT(tt, logn)
	for u = 0; u < n; u++ {
		if int(*(*uint16)(unsafe.Add(unsafe.Pointer(tt), unsafe.Sizeof(uint16(0))*uintptr(u)))) == 0 {
			return 0
		}
		*(*uint16)(unsafe.Add(unsafe.Pointer(h), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(mq_div_12289(uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(h), unsafe.Sizeof(uint16(0))*uintptr(u)))), uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(tt), unsafe.Sizeof(uint16(0))*uintptr(u))))))
	}
	mq_iNTT(h, logn)
	return 1
}
func PQCLEAN_FALCON512_CLEAN_complete_private(G *int8, f *int8, g *int8, F *int8, logn uint, tmp *uint8) int {
	var (
		u  uint64
		n  uint64
		t1 *uint16
	...
	n = uint64(1 << logn)
	t1 = (*uint16)(unsafe.Pointer(tmp))
	t2 = (*uint16)(unsafe.Add(unsafe.Pointer(t1), unsafe.Sizeof(uint16(0))*uintptr(n)))
	for u = 0; u < n; u++ {
		*(*uint16)(unsafe.Add(unsafe.Pointer(t1), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(mq_conv_small(int(*(*int8)(unsafe.Add(unsafe.Pointer(g), u)))))
		*(*uint16)(unsafe.Add(unsafe.Pointer(t2), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(mq_conv_small(int(*(*int8)(unsafe.Add(unsafe.Pointer(F), u)))))
	}
	mq_NTT(t1, logn)
	mq_NTT(t2, logn)
	...
	mq_NTT(t2, logn)
	for u = 0; u < n; u++ {
		if int(*(*uint16)(unsafe.Add(unsafe.Pointer(t2), unsafe.Sizeof(uint16(0))*uintptr(u)))) == 0 {
			return 0
		}
		*(*uint16)(unsafe.Add(unsafe.Pointer(t1), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(mq_div_12289(uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(t1), unsafe.Sizeof(uint16(0))*uintptr(u)))), uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(t2), unsafe.Sizeof(uint16(0))*uintptr(u))))))
	}
	mq_iNTT(t1, logn)
	for u = 0; u < n; u++ {
		var (
		...
		w = uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(t1), unsafe.Sizeof(uint16(0))*uintptr(u))))
		w -= uint32(int32(Q & ^-((int(w) - (int(Q >> 1))) >> 31)))
		gi = *(*int32)(unsafe.Pointer(&w))
		if int(gi) < -127 || int(gi) > +127 {
			return 0
		}
		*(*int8)(unsafe.Add(unsafe.Pointer(G), u)) = int8(gi)
	}
	return 1
}
func PQCLEAN_FALCON512_CLEAN_is_invertible(s2 *int16, logn uint, tmp *uint8) int {
	var (
		u  uint64
		n  uint64
		tt *uint16
	...
	r = 0
	for u = 0; u < n; u++ {
		r |= uint32(int32(int(*(*uint16)(unsafe.Add(unsafe.Pointer(tt), unsafe.Sizeof(uint16(0))*uintptr(u)))) - 1))
	}
	return 1 - (int(r) >> 31)
}
func PQCLEAN_FALCON512_CLEAN_verify_recover(h *uint16, c0 *uint16, s1 *int16, s2 *int16, logn uint, tmp *uint8) int {
	var (
		u  uint64
		n  uint64
		tt *uint16
	...
	for u = 0; u < n; u++ {
		...
		w += uint32(int32(Q & int(uint32(int32(-(int(w) >> 31))))))
		*(*uint16)(unsafe.Add(unsafe.Pointer(tt), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(w)
		w = uint32(*(*int16)(unsafe.Add(unsafe.Pointer(s1), unsafe.Sizeof(int16(0))*uintptr(u))))
		w += uint32(int32(Q & int(uint32(int32(-(int(w) >> 31))))))
		w = mq_sub(uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(c0), unsafe.Sizeof(uint16(0))*uintptr(u)))), w)
		*(*uint16)(unsafe.Add(unsafe.Pointer(h), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(w)
	}
	mq_NTT(tt, logn)
	mq_NTT(h, logn)
	r = 0
	...
	mq_iNTT(h, logn)
	r = uint32(int32(int(^r) & int(uint32(int32(-PQCLEAN_FALCON512_CLEAN_is_short(s1, s2, logn))))))
	return int(r) >> 31
}
func PQCLEAN_FALCON512_CLEAN_count_nttzero(sig *int16, logn uint, tmp *uint8) int {
	var (
		s2 *uint16
		u  uint64
		n  uint64
	...
	n = uint64(1 << logn)
	s2 = (*uint16)(unsafe.Pointer(tmp))
	for u = 0; u < n; u++ {
		var w uint32
		w = uint32(*(*int16)(unsafe.Add(unsafe.Pointer(sig), unsafe.Sizeof(int16(0))*uintptr(u))))
		w += uint32(int32(Q & int(uint32(int32(-(int(w) >> 31))))))
		*(*uint16)(unsafe.Add(unsafe.Pointer(s2), unsafe.Sizeof(uint16(0))*uintptr(u))) = uint16(w)
	}
	mq_NTT(s2, logn)
	r = 0
	for u = 0; u < n; u++ {
		var w uint32
		w = uint32(int32(int(uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(s2), unsafe.Sizeof(uint16(0))*uintptr(u))))) - 1))
		r += uint32(int32(int(w) >> 31))
	}
	return int(r)
}
